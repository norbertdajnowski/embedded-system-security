...
class signalJam(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Signal Jammer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Jammer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signalJam")
        ...
        # Variables
        ##################################################
        self.target_freq = target_freq = 5e9
...
def main(top_block_cls=signalJam, options=None):
